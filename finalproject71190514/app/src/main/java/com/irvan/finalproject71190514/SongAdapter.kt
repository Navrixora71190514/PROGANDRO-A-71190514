...
class SongAdapter (var listSong: ArrayList<DaftarLagu>, var context: Context): RecyclerView.Adapter<SongAdapter.SongHolder>() {
    var firestore: FirebaseFirestore? = null

    val mainList = listSong
    val searchList = ArrayList<DaftarLagu>(listSong)

    class SongHolder(val view : View): RecyclerView.ViewHolder(view){

        @SuppressLint("RestrictedApi")
        fun bind(lagu: DaftarLagu, context: Context){
            ...
            buttonUpdate.setOnClickListener {
                val i: Intent = Intent(view.context, UpdateLagu::class.java)
            ...
            buttonHapus.setOnClickListener {
                firestore?.collection(lagu.akun)
                    ...
                    ?.addOnSuccessListener {
                        val i: Intent = Intent(view.context, HalamanLogin::class.java)
                        context.startActivity(i)
