...
import com.irvan.finalproject71190514.databinding.TambahlaguBinding
import com.irvan.finalproject71190514.databinding.UpdatelaguBinding
import java.text.SimpleDateFormat
import java.util.*

class UpdateLagu : AppCompatActivity() {
    val cal = Calendar.getInstance()
    var firestore: FirebaseFirestore? = null
    lateinit var ImageUri : Uri
    lateinit var binding : UpdatelaguBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = UpdatelaguBinding.inflate(layoutInflater)
        ...
        accept.setOnClickListener {
            ...
            if (judul!=null && penyanyi!=null && album!=null && genre!=null && kalendar!=null){
                if (acct!=null){
                    ...
                    val albumLagu = DaftarLagu(judul.text.toString(), penyanyi.text.toString(), album.text.toString(), genre.text.toString(), kalendar2, personName.toString())
